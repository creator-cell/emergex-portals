...
const chartData = [
  { browser: "Hazard and Risk Assesment", visitors: 20, fill: "rgba(254, 108, 108, 1)" },
  { browser: "Resource Inventory", visitors: 87, fill: "rgba(254, 184, 108, 1)" },
  { browser: "Communication Systems", visitors: 73, fill: "rgba(254, 108, 169, 1)" },
  ...
  return (
    <Card className="flex flex-col xl:flex-row 2xl:flex-row items-center bg-transparent border-0 shadow-none py-0">
      ...
      <div className="flex flex-col items-start py-2 px-2 space-y-2 border-0 shadow-none mr-8">
        {chartData.map((data) => (
          <div key={data.browser} className="flex items-center justify-between w-full ">
