...
export const ClientProjectCard: React.FC<ClientProjectCardProps> = ({ id, name, country, worksite,_id }) => (
  <Card className="p-6 rounded-[20px]">
        <Link href={`/exploration-and-production/${_id}`}>
      <div className="flex flex-col sm:flex-row justify-between items-center">
        <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 flex-1">
          <div>
            <div className="text-[12PX] text-gray-500">Project ID</div>
            <div className="text-[16px] font-medium">{id}</div>
          </div>
          <div>
            <div className="text-[12PX] text-gray-500">Project Name</div>
