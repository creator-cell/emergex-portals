...
const TaskRow: React.FC<TaskRowProps> = ({ data, className }) => {
  ...
  const { type: taskHead, level, project,createdAt,isStopped,stoppedTime }: { createdAt:Date,type: string, level: string, project: Project,_id:string,isStopped:boolean,stoppedTime:Date } = data;
