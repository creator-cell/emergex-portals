...
const Tabs: React.FC<AdminTabsProps> = ({ data }) => {
  ...
  return (
    ...
    >
      ...
      >
        <TabsTrigger
          value="In Progress"
          className={` w-4 md:w-36 relative ${activeTab === "In Progress" && "bg-[#f1f6f0] rounded-b-none active"
        ...
        <TabsTrigger
          value="Completed"
          className={` w-4 md:w-36 relative ${activeTab === "Completed" &&
        ...
        <TabsTrigger
          value="Cancelled"
          className={` relative w-4 md:w-36 ${activeTab === "Cancelled" &&
            "bg-[#f1f6f0] active active-before rounded-b-none"
            }  pt-4 pb-8 px-8 rounded-t-[40px] `}
        >
          Cancelled
        ...
        <TabsTrigger
          value="Assigned"
          className={` relative w-4 md:w-36 ${activeTab === "Assigned" &&
            "bg-[#f1f6f0] active active-before rounded-b-none"
            }  pt-4 pb-8 px-8 rounded-t-[40px] `}
        >
          Assigned
        ...
        <TabsTrigger
          value="Delayed"
          className={` relative w-4 md:w-36 ${activeTab === "Delayed" &&
            "bg-[#f1f6f0] active active-before rounded-b-none"
            }  pt-4 pb-8 px-8 rounded-t-[40px] `}
        >
          Delayed
      ...
      >
        {data
          ...
          .map((item) => (
            <TaskRow key={item?._id} data={item} />
          ))}
      </TabsContent>
    </TabContainer>
  );
